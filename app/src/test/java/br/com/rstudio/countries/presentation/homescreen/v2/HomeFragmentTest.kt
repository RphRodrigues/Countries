...
class HomeFragmentTest {
  ...
  private lateinit var fragment: FragmentScenario<HomeFragment>
  ...
  fun `given list fragment is initiated with success then check if the countries are displayed`() {
    ...
    fragment = launchFragmentInContainer<HomeFragment>()

    fragment.onFragment {
      UiVerify.checkViewIsDisplayed("Most Popular")
      ...
      UiVerify.scrollToPosition(R.id.main_recycler_view, 2)
